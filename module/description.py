...
class Description(object):
    ...
    def init(self, key_list=list(desc_key_map.keys())):
        ...
        try:
            ...
            return -1011005, '描写对象初始化错误:描写环心理模型初始化错误'
    ...
    def get_all_descriptions(self, sent_list, essay_type='common'):
        ...
        try:
            ...
            info = {}
            info['psychology'] =  {'pred_result': [], 'match_result': []}
            ...
            description_info['description'] = "描写模块批处理:心理模块处理错误!"
